...
# Training
train('data/train_data_1.txt', 3)
train('data/train_data_2.txt', 3)
train('data/train_data_3.txt', 3)

# Testing
train('data/test_data_4.txt', 3)

reset_weights()

# Training
train('data/train_data_1.txt', 2)
train('data/train_data_2.txt', 2)
train('data/train_data_3.txt', 2)

# Testing
train('data/test_data_4.txt', 2)

reset_weights()

# Training
train('data/train_data_1.txt', 1)
train('data/train_data_2.txt', 1)
train('data/train_data_3.txt', 1)

# Testing
train('data/test_data_4.txt', 1)
